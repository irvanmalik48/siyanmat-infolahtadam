          ...
          <div className="flex flex-col w-full gap-3">
            ...
            {activity?.tools.map((tool) => (
              <Link
                ...
                className="flex flex-col w-full gap-5 p-5 transition border rounded-lg group border-neutral-300 hover:border-celtic-800 hover:bg-celtic-50 hover:bg-opacity-50 hover:ring-4 hover:ring-celtic-800 hover:ring-opacity-50"
              >
                <div className="flex flex-col w-full gap-1">
